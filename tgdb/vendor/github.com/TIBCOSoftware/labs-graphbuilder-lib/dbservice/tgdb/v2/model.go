...
type EntityKeeper interface {
	Populate(tgConnection types.TGConnection)
...
func (this *UpsertEntityKeeper) Populate(tgConnection types.TGConnection) {
...
func (this *DeleteEntityKeeper) Populate(tgConnection types.TGConnection) {
