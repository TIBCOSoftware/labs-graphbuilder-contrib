...
type TGDBService struct {
	...
	_tgConnection    tgdb.TGConnection
	_gof             tgdb.TGGraphObjectFactory
	_gmd             tgdb.TGGraphMetadata
	_keyMap          map[string][]string
	_nodeAttrMap     map[string]map[string]tgdb.TGAttributeDescriptor
	_edgeAttrMap     map[string]map[string]tgdb.TGAttributeDescriptor
	_mux             sync.Mutex
}

func (this *TGDBService) ensureConnection() tgdb.TGError {
	...
	if nil == this._tgConnection {
		...
		this._tgConnection, err = factory.GetConnectionFactory().CreateConnection(this._url, this._user, this._password, this._connectionProps)
		if nil != err {
...
func (this *TGDBService) GetFactory() (tgdb.TGGraphObjectFactory, error) {
	if nil != this._gof {
...
func (this *TGDBService) GetMetadata() (tgdb.TGGraphMetadata, error) {
	if nil != this._gmd {
...
func (this *TGDBService) GetNodeType(nodeTypeStr string) (tgdb.TGNodeType, error) {
...
func (this *TGDBService) GetEdgeType(edgeTypeStr string) (tgdb.TGEdgeType, error) {
	gdm, err := this.GetMetadata()
	if nil != err {
		return nil, err
	}
...
func (this *TGDBService) commit(readyEntity EntityKeeper) tgdb.TGError {
	...
	if nil == edgeWrapper {
		...
		if nil == edgeWrapper {
			...
			if nil != edgeType {
				...
				direction := tgdb.DirectionTypeUnDirected
				if nil != iDirection {
					...
					case 0:
						...
						break
					case 1:
						direction = tgdb.DirectionTypeDirected
						break
					case 2:
						direction = tgdb.DirectionTypeBiDirectional
						break
					}
				}
...
func (this *TGDBService) GetNode(nodeType string, parameter map[string]interface{}) (tgdb.TGEntity, error) {
	return this.fetchNode(nodeType, parameter)
}

func (this *TGDBService) GremlinQuery(para map[string]interface{}) (tgdb.TGResultSet, tgdb.TGError) {
	var queryString string
	if nil == para["query"] {
		return nil, &impl.TGDBError{ErrorMsg: "No query parameter defined!"}
	}
...
func (this *TGDBService) TGQLQuery(para map[string]interface{}) (tgdb.TGResultSet, tgdb.TGError) {
	var queryString string
...
func (this *TGDBService) OnException(ex tgdb.TGError) {
	logger.Warn("***************************************************************")
...
func (this *TGDBService) fetchNode(fromType string, fromNode map[string]interface{}) (tgdb.TGNode, error) {
...
func (this *TGDBService) search(
	...
	edgeKey map[string]interface{}) (tgdb.TGNode, error) {
	...
	if nil == err {
		if nil != resultSet {
			...
			startingNode = result.(tgdb.TGNode)
		}
	} else {
		return nil, err
	}
...
func (this *TGDBService) populateAttributes(
	...
	attributesData map[string]interface{}) tgdb.TGEntity {
...
func (this *TGDBService) createNode(nodeTypeStr string) (tgdb.TGNode, tgdb.TGError) {
...
func (this *TGDBService) fetchMetadata() tgdb.TGError {
	...
	for _, nodeType := range nodeTypes {
		...
		attrs := make(map[string]tgdb.TGAttributeDescriptor)
...
func (this *TGDBService) buildQueryOption(para map[string]interface{}) tgdb.TGQueryOption {
	option := impl.NewQueryOption()
